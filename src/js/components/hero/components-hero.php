...
if ( get_row_layout() == 'hero' ) :
    ...
    $post_type_title = is_archive() ? bold_last_string( titleizeit( get_post_type() ) ) : bold_last_string( get_the_title() );
    ...
    $post_title = '<span data-styles="' . esc_attr( $title_component->styles() ) . '" class="' . esc_attr( $title_component->class_names() ) . '"><h1>' . esc_sql( $post_type_title ) . '</h1></span>';
