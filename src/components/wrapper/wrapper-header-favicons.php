...
<meta name="msapplication-TileColor" content="<?php echo esc_attr( $favicon_application_color ); ?>">
<meta name="theme-color" content="<?php echo esc_attr( $favicon_application_color ); ?>">
<?php
if ( ! empty( $has_favicons ) ) :
    ...
    <link rel="mask-icon" href="<?php echo esc_url( $favicon_url ); ?>/safari-pinned-tab.svg?v=<?php echo esc_attr( $favicon_version ); ?>" color="<?php echo esc_attr( $favicon_application_color ); ?>">
    <?php
endif;
